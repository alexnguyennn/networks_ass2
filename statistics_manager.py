...
class StatisticsManager:
	...
	def print_statistics(self):
		print("total number of virtual circuit requests: {}".format(self.total_requests))
		print("total number of packets: {}".format(self.total_pkts))
		print("number of successfully routed packets: {}".format(self.pkt_success_num))
		print("percentage of successfully routed packets: {0:.2f}".format(self.pkt_success_rate))
		print("number of blocked packets: {}".format(self.pkt_blocked_num))
		print("percentage of blocked packets: {0:.2f}".format(self.pkt_blocked_rate))
		print("average number of hops per circuit: {0:.2f}".format(self.ave_hops))
		print("average cumulative propagation delay per circuit: {0:.2f}".format(self.ave_delay))
